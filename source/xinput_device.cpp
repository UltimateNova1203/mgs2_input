#include "../include/xinput_device.h"
#define XINPUT_DPAD_STALK
...
void poll_xinput() {
    for (DWORD ControllerIndex = 0; ControllerIndex < XUSER_MAX_COUNT; ++ControllerIndex) {
        ...
        if (XInputGetState(ControllerIndex, &ControllerState) == ERROR_SUCCESS) {
            ...
            xinputDpadUp = Pad->wButtons & XINPUT_GAMEPAD_DPAD_UP;
            xinputDpadDown = Pad->wButtons & XINPUT_GAMEPAD_DPAD_DOWN;
            xinputDpadLeft = Pad->wButtons & XINPUT_GAMEPAD_DPAD_LEFT;
            xinputDpadRight = Pad->wButtons & XINPUT_GAMEPAD_DPAD_RIGHT;
            xinputStart = Pad->wButtons & XINPUT_GAMEPAD_START;
            xinputBack = Pad->wButtons & XINPUT_GAMEPAD_BACK;
            xinputLeftThumb = Pad->wButtons & XINPUT_GAMEPAD_LEFT_THUMB;
            xinputRightThumb = Pad->wButtons & XINPUT_GAMEPAD_RIGHT_THUMB;
            xinputLeftShoulder = Pad->wButtons & XINPUT_GAMEPAD_LEFT_SHOULDER;
            xinputRightShoulder = Pad->wButtons & XINPUT_GAMEPAD_RIGHT_SHOULDER;
            xinputA = Pad->wButtons & XINPUT_GAMEPAD_A;
            xinputB = Pad->wButtons & XINPUT_GAMEPAD_B;
            xinputX = Pad->wButtons & XINPUT_GAMEPAD_X;
            xinputY = Pad->wButtons & XINPUT_GAMEPAD_Y;
            xinputLeftTrigger = Pad->bLeftTrigger;
            xinputRightTrigger = Pad->bRightTrigger;
            xinputLeftStickX = Pad->sThumbLX;
            xinputLeftStickY = Pad->sThumbLY;
            xinputRightStickX = Pad->sThumbRX;
            xinputRightStickY = Pad->sThumbRY;
        }
    }
}
